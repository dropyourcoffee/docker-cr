...
import { toPrimaryDark } from "@styles/colors";
...
export const Base = styled.p<BaseFontStyle>`
  color: ${(props) => props.color || props.theme.color.textPrimary};
...
export const Subtitle1 = styled.p<SubTitleFontStyle>`
  ...
  font-family: "Inter";
  ${(props) => props.lineHeight && lineHeightStyle(props.lineHeight)}
  color: ${(props) => props.color || toPrimaryDark(props.theme.color.textPrimary)};
`;
// 600 0.9375 Inter
